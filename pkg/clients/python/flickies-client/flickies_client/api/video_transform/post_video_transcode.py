...
from ...models.video_transcode_request import VideoTranscodeRequest
...
def sync_detailed(
    *,
    ...
    """
    Args:
        body (VideoTranscodeRequest): Universal re-encode. `output_format` in
            BaseVideoOutputRequest drives
